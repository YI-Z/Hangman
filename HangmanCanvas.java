 ...
 */
	public void noteIncorrectGuess(char letter) {
		...
		GLine left_leg_up = new GLine(getWidth()/2,SCAFFOLD_OFFSET+ROPE_LENGTH+2*HEAD_RADIUS+BODY_LENGTH,
								getWidth()/2-HIP_WIDTH,SCAFFOLD_OFFSET+ROPE_LENGTH+2*HEAD_RADIUS+BODY_LENGTH);
		GLine left_leg_down = new GLine(getWidth()/2-HIP_WIDTH,SCAFFOLD_OFFSET+ROPE_LENGTH+2*HEAD_RADIUS+BODY_LENGTH,
								getWidth()/2-HIP_WIDTH,SCAFFOLD_OFFSET+ROPE_LENGTH+2*HEAD_RADIUS+BODY_LENGTH+LEG_LENGTH);
		GLine right_leg_up = new GLine(getWidth()/2,SCAFFOLD_OFFSET+ROPE_LENGTH+2*HEAD_RADIUS+BODY_LENGTH,
								getWidth()/2+HIP_WIDTH,SCAFFOLD_OFFSET+ROPE_LENGTH+2*HEAD_RADIUS+BODY_LENGTH);
		GLine right_leg_down = new GLine(getWidth()/2+HIP_WIDTH,SCAFFOLD_OFFSET+ROPE_LENGTH+2*HEAD_RADIUS+BODY_LENGTH,
								getWidth()/2+HIP_WIDTH,SCAFFOLD_OFFSET+ROPE_LENGTH+2*HEAD_RADIUS+BODY_LENGTH+LEG_LENGTH);		
		GLine left_foot = new GLine(getWidth()/2-HIP_WIDTH,SCAFFOLD_OFFSET+ROPE_LENGTH+2*HEAD_RADIUS+BODY_LENGTH+LEG_LENGTH,
								getWidth()/2-HIP_WIDTH-FOOT_LENGTH,SCAFFOLD_OFFSET+ROPE_LENGTH+2*HEAD_RADIUS+BODY_LENGTH+LEG_LENGTH);
		GLine right_foot = new GLine(getWidth()/2+HIP_WIDTH,SCAFFOLD_OFFSET+ROPE_LENGTH+2*HEAD_RADIUS+BODY_LENGTH+LEG_LENGTH,
				getWidth()/2+HIP_WIDTH+FOOT_LENGTH,SCAFFOLD_OFFSET+ROPE_LENGTH+2*HEAD_RADIUS+BODY_LENGTH+LEG_LENGTH);
		//add in the handman
		switch (wrong.length())
		{
